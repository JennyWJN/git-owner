...
////			for (final Entry<Integer, List<Frequency>> entry : frequenciesForControlDependence
////					.entrySet()) {
////
...
//////				}
////			}
////			printFrequencies(DEPENDENCE_TYPE.CONTROL.text, texts, frequenciesForExecutionDependence);
...
//			//printFrequencies("execution", texts, frequenciesForExecutionDependence);
